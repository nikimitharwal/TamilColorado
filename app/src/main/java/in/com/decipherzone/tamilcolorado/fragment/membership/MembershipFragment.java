package in.com.decipherzone.tamilcolorado.fragment.membership;
...
public class MembershipFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentView = inflater.inflate(R.layout.fragment_membership, container, false);
        initializeView();
        return fragmentView;
    }
    ...
    public void initializeView() {
        ...
        mainActivity.setActionBarTitle(activity.getString(R.string.title_membership));
    }
}
